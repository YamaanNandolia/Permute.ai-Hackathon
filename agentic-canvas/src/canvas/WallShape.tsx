...
import type { Wall } from '../types/shapes';
...
export const WallShape: React.FC<WallShapeProps> = React.memo(({ shape }) => {
  ...
  const isLoadBearing = shape.metadata.isLoadBearing;
  ...
  return (
    <>
      <Rect
        ...
        draggable={shape.draggable && !isLoadBearing}
        onClick={handleClick}
        onTap={handleClick}
        onDragEnd={handleDragEnd}
        onTransformEnd={handleTransformEnd}
        shadowBlur={isLoadBearing ? 5 : 0}
        shadowOpacity={isLoadBearing ? 0.3 : 0}
      />
      {isSelected && (
        <Transformer
          ref={transformerRef}
